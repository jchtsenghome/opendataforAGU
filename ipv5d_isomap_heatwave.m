...
fid=fopen('E:/matscript/ncep/l2dist_NHipv5d_sqrt_JJA_1980_2022.txt.dat','r');
...
%[Y R E] = Isomap(D,'k',20);
%[Y R E] = Isomap(D,'k',30);
fidR=fopen('e:/matscript/ncep/ISOMAP_K14_hgt_ResVar_results','w');
fprintf(fidR,'%7.5f\n',R);
...
% write out the K nearest value
     ...
     titstr=['ISOMAP IPV 340K 5d JJA (1980-2022) NH domain PCs K= ' noneigh];
...
%     yyget2=yyget(648,:); yy2mon2=yyget2(1:6);          
     ...
     axis([-2.e-4,2.e-4, -2.e-4,2.e-4, -2.e-4,2.e-4]);
     ...
     titstr=strcat('ISOMAP IPV 340K Pentad NH domain PCs, from',s3,yy2mon1,s3,'-',s3,yy2mon2,'  K= ',noneigh);
     title(titstr,'fontsize',13,'color',[0.7 0.2 0.2]);
...
%  count the distance
%
fid3=fopen('e:/matscript/ncep/Dist_ipv5d_iso3D_JJA_1980_2022.txt','w');
fid4=fopen('e:/matscript/ncep/Dist_ipv5d_iso20D_JJA_1980_2022.txt','w');
...
%
fid5=fopen('e:/matscript/ncep/LoopDist_ipv5d_iso3D_JJA_1980_2022.txt','w');
fid6=fopen('e:/matscript/ncep/LoopDist_ipv5d_iso20D_JJA_1980_2022.txt','w');
yyget1=yyget(1,:);      yearini=str2num(yyget1(1:4));
yyget1=yyget(774,:); yearend=str2num(yyget1(1:4));
Drsvm=Dr2(:,1:3);
Drsvm20=Dr2(:,1:20);
...
titstr=strcat('ISOMAP IPV 340K Pentad NH domain PC 1, from',s3,yy2mon1,s3,'-',s3,yy2mon2,'  K= ',noneigh);
title(titstr,'fontsize',13,'color',[0.7 0.2 0.2]);
...
%legend('train','real','predict');
titstr=strcat('ISOMAP IPV 340K Pentad NH domain PC 2, from',s3,yy2mon1,s3,'-',s3,yy2mon2,'  K= ',noneigh);
title(titstr,'fontsize',13,'color',[0.7 0.2 0.2]);
set(gca,'FontName','Arial Black','FontSize',14,'LineWidth',2.0);
grid on;
