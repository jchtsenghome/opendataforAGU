% read distance file
% filename: readipv5d_EA_vdist.m
%
clear; close all;

% experiment setup
noneigh='2';
chdomain='(70-120E, 20-40N)';
...
[yymon vdist]=textread('E:/matscript/ncep/Dist_ipv5d_iso3D_EA_JJA_1980_2022.txt','%d%f');
[yymon vdist20]=textread('E:/matscript/ncep/Dist_ipv5d_iso20D_EA_JJA_1980_2022.txt','%d%f');
yearini=1980;
yearend=2022;
...
legend('Jun','Jul','Aug');
titstr_3d=strcat('The Distances from IPV5d ISOMAP  K= ',s3,noneigh,s3,chdomain,s3,'leading 3 PCs');
title(titstr_3d,'fontsize',13,'color',[0.7 0.2 0.2]);
%title('The Distances from IPV5d ISOMAP (70-120E,20-40N) leading 3 PCs','fontsize',13,'color',[0.7 0.2 0.2]); 
...
titstr_20d=strcat('The Distances from IPV5d ISOMAP  K= ',s3,noneigh,s3,chdomain,s3,'leading 20 PCs');
title(titstr_20d,'fontsize',13,'color',[0.7 0.2 0.2]);
%title('The Distances from ISOMAP leading 20 PCAs','fontsize',13,'color',[0.7 0.2 0.2]); 
%title('The Distances from IPV5d ISOMAP (70-120E,20-40N) leading 20 PCs','fontsize',13,'color',[0.7 0.2 0.2]); 
set(gca,'FontName','Arial Black','FontSize',12,'LineWidth',2.0);
grid on;
...
titstrallJJA=strcat('Distances from IPV5d ISOMAP  K= ',s3,noneigh,s3,chdomain,s3,'leading 3 and 20 PCs');
title(titstrallJJA,'fontsize',13,'color',[0.7 0.2 0.2]);
...
figure (21);
set(gca,'FontName','Arial Black','FontSize',20,'LineWidth',4.0);

yyaxis left;
h1=plot(dateSeq(1:3:end),rep_vdist3d_all(1:3:end),'-s','linewidth',2,'color',[0.3 0.5 0.75]); hold on;
yyaxis right;
h2=plot(dateSeq(1:3:end), rep_vdist20d_all(1:3:end), '-s','linewidth',2,'color',[0.8 0.2 0.2]); hold on;
...
%title('1980-2022 June-August IPV 5-d ISOMAP Distances','fontsize',13,'color',[0.7 0.2 0.2]); 
titstrallJJA=strcat('Distances from IPV 5-d ISOMAP  K= ',s3,noneigh,s3,chdomain,s3,'leading 3 and 20 PCs');
title(titstrallJJA,'fontsize',13,'color',[0.7 0.2 0.2]);
set(gca,'FontName','Arial Black','FontSize',12,'LineWidth',2.0);
grid on;
...
[yymon vdistloop]=textread('E:/matscript/ncep/LoopDist_ipv5d_iso3D_EA_JJA_1980_2022.txt','%d%f');
[yymon vdist20loop]=textread('E:/matscript/ncep/LoopDist_ipv5d_iso20D_EA_JJA_1980_2022.txt','%d%f');
yearini=1980;
yearend=2022;
yylast=yearend-yearini+1;
iym6=1;
...
titstr_loop3d=strcat('The Loop Distances from IPV5d ISOMAP  K= ',s3,noneigh,s3,chdomain,s3,'leading 3 PCs');
title(titstr_loop3d,'fontsize',13,'color',[0.7 0.2 0.2]);
%title('The Loop Distances from IPV5d ISOMAP (70-120E,20-40N) leading 3 PCs','fontsize',13,'color',[0.7 0.2 0.2]); 
set(gca,'FontName','Arial Black','FontSize',12,'LineWidth',2.0);
grid on;
...
titstr_loop20d=strcat('The Loop Distances from IPV5d ISOMAP  K= ',s3,noneigh,s3,chdomain,s3,'leading 20 PCs');
title(titstr_loop20d,'fontsize',13,'color',[0.7 0.2 0.2]);
%title('The Loop Distances from IPV5d ISOMAP (70-120E,20-40N) leading 20 PCs','fontsize',13,'color',[0.7 0.2 0.2]); 
set(gca,'FontName','Arial Black','FontSize',12,'LineWidth',2.0);
grid on;
...
% plot all JJA
[yymon vdistloop]=textread('E:/matscript/ncep/LoopDist_ipv5d_iso3D_EA_allJJA_1980_2022.txt','%d%f');
[yymon vdist20loop]=textread('E:/matscript/ncep/LoopDist_ipv5d_iso20D_EA_allJJA_1980_2022.txt','%d%f');
yearini=1980;
yearend=2022;
yylast=yearend-yearini+1;
...
legend('JJA 3 PCs','JJA 20 PCs');
titstrallJJA=strcat('The Loop Distances from IPV5d ISOMAP  K= ',s3,noneigh,s3,chdomain,s3,'leading 3 and 20 PCs');
title(titstrallJJA,'fontsize',13,'color',[0.7 0.2 0.2]);
%title('The Loop Distances from IPV5d ISOMAP (70-120E,20-40N) leading 3 and 20 PCs','fontsize',13,'color',[0.7 0.2 0.2]); 
set(gca,'FontName','Arial Black','FontSize',12,'LineWidth',2.0);
grid on;
end % end if of switch_plot_old
...
%title('The Loop Distance of 1980-2022 June-August IPV 5-d ISOMAP','fontsize',13,'color',[0.7 0.2 0.2]); 
titstrallJJA=strcat('Loop Distances from IPV 5-d ISOMAP  K= ',s3,noneigh,s3,chdomain,s3,'leading 3 and 20 PCs');
title(titstrallJJA,'fontsize',13,'color',[0.7 0.2 0.2]);
set(gca,'FontName','Arial Black','FontSize',12,'LineWidth',2.0);
grid on;
